export const openings = [
    ...
    { appliesTo: 'white', name: '85% win (Van Geet??)', moves: 'b1-c3 d7-d5 e2-e4 d5-d4 c3-e2 e7-e5 e2-g3 c7-c5 g1-f3 b8-c6 f1-c4 f8-d6 d2-d3 g8-e7 f3-g5 e8-g8&h8-f8 d1-h5 h7-h6 g5-f7 f8-f7 h5-f7 g8-h7 c1-h6 h7-h6 f7-h5 #'.split(' '), url: 'https://www.youtube.com/watch?v=pogv0YLR7sc' },

    { appliesTo: 'white', name: 'Van Geet', moves: 'b1-c3 d7-d5 e2-e4 d5-d4 c3-e2 e7-e5 e2-g3 c7-c5 g1-f3 b8-c6 f1-c4 f8-d6 d2-d3 g8-e7 f3-g5 e8-g8&h8-f8 d1-h5 h7-h6 g5-f7 f8-f7 h5-f7 g8-h7 c1-h6 h7-h6 f7-h5 #'.split(' '), url: 'https://www.youtube.com/watch?v=pogv0YLR7sc' },
    ...
    { appliesTo: 'black', name: 'Van Geet Counter : Nowukunski Gambit', moves: 'b1-c3 e7-e5 f2-f4 e5-f4 e2-e4 f4-e4&e4-e3 g1-f3 e3-d2 e1-d2 d7-d5 d2-e2 g8-f6 e2-f2 f8-c5 c1-e3 f6-g4 f2-g3 c5-d6 g3-h3 g4-f2 #'.split(' '), url: 'https://www.youtube.com/watch?v=XGu4tp3rS40' },
    { appliesTo: 'black', name: 'Van Geet Counter (1)', moves: 'b1-c3 d7-d5 g1-f3 d5-d4 c3-e4 b8-c6 e2-e3 d4-e3 d2-e3 d8-d1 e1-d1 e7-e5 f1-d3 f7-f5 e4-g3 e5-e4 d3-b5 e4-f3 g2-f3 f8-e7 d1-e2 g7-g6 b2-b3 e7-f6 a1-b1 g8-e7 h1-d1 c8-e6 b5-d3 e8-c8&a8-d8 c2-c4 c6-b4 c1-b2 f6-b2 b1-b2 b7-b5 c4-b5 e7-d5 e3-e4 d5-c3 e2-e3 c3-d1 e3-f4 b4-d3 f4-g5 d1-b2 e4-f5 g6-f5 g3-h5 h8-g8 g5-f6 g8-g6 f6-e7 d8-d7 e7-e8 g6-g8 #'.split(' '), url: 'https://www.youtube.com/watch?v=eG_p4ZngYE4' },
    ...
    { appliesTo: 'black', name: 'Fishing Pole Trap', moves: 'e2-e4 e7-e5 g1-f3 b8-c6 f1-b5 g8-f6 e1-g1&h1-f1 f6-g4 h2-h3 h7-h5 h3-g4 h5-g4 * d8-h4 f1-e1 h4-h2 g1-f1 c6-d4 * h2-h1 #'.split(' '), url: 'https://www.youtube.com/shorts/dVZMtqxDmLc' },

    { appliesTo: 'black', name: 'Englund Gambit Declined Trap', moves: 'd2-d4 e7-e6 e2-e4 d7-d5 b1-c3 c7-c5 g1-f3 b8-c6 e4-d5 e6-d5 f1-e2 g8-f6 e1-g1&h1-f1 f8-e7 c1-g5 e8-g8&h8-f8 d4-c5 c8-e6 f3-d4 e7-c5 d4-e6 f7-e6 e2-g4 d8-d6 g4-h3 a8-e8 d1-d2 c5-b4 g5-f6 f8-f6 a1-d1 d6-c5 d2-e2 b4-c3 b2-c3 c5-c3 d1-d5 c6-d4 e2-h5 e8-f8 d5-e5 f6-h6 h5-g5 h6-h3 e5-c5 c3-g3 h2-g3 d4-e2'.split(' '), url: 'https://www.youtube.com/shorts/HWWoP02A3XE' },

    { appliesTo: 'white', name: 'Scandinavian Defense: Marshall Gambit Trap', moves: 'e2-e4 b8-c6 d2-d4 d7-d5 e4-d5 d8-d5 b1-c3 d5-d4 d1-e2 c8-g4 f2-f3 g4-h5 c1-e3 d4-b4 e1-c1&a1-d1 a7-a6 c3-d5 b4-a5 e3-b6 c7-b6 d5-c7 #'.split(' '), url: 'https://www.youtube.com/shorts/xhX1oFT29gc' },
    { appliesTo: 'white', name: 'Sem-Slav: Marshall Gambit', moves: 'd2-d4 d7-d5 c2-c4 e7-e6 b1-c3 c7-c6 e2-e4 f8-d6 g1-f3 g8-e7 f1-d3 h8-f8&e8-g8 e4-e5 d6-c7 d3-h7 g8-h7 f3-g5 h7-g6 h2-h4 e7-f5 h4-h5'.split(' '), url: 'https://www.youtube.com/shorts/M4w6G-nbh5E' },
